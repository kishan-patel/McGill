...
#define nstates3	11	/* cook */
#define minseq3	37
#define maxseq3	46
#define endstate3	10

#define nstates2	10	/* client */
#define minseq2	28
#define maxseq2	36
#define endstate2	9

#define nstates1	21	/* round_robin_arbiter */
#define minseq1	8
#define maxseq1	27
#define endstate1	20

#define nstates0	9	/* never_0 */
#define minseq0	0
#define maxseq0	7
#define endstate0	8
...
#define Pcook	((P3 *)this)
typedef struct P3 { /* cook */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air3	(sizeof(P3) - Offsetof(P3, id) - 1*sizeof(uchar))
...
#define Pround_robin_arbiter	((P1 *)this)
typedef struct P1 { /* round_robin_arbiter */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, i) - 1*sizeof(short))

typedef struct P0 { /* never_0 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
