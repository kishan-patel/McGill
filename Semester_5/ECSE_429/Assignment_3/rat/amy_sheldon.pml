...
//The following mtypes are states.Makes it easier to check states
mtype stateofAmy = ideal;
mtype stateofSheldon = ideal;
mtype stateofSwitchA = ideal;
mtype stateofSwitchB = ideal;
//The following are used as signals.
//chose to use booleans rather then a chan for assertion purposes
bool offhookAmy = 0;
...
proctype amy(){
  do
    ::
      if
        ::printf("Still Ideal");//Ideal Loop back
        ::printf("picked up");
          stateofAmy = offhook;
          offhookAmy = 1;
          (dialtone == 1);
          ...
          dialtone = 0;
          //once you get a dialtone, you can dial.
          stateofAmy = dialing;
          //teledigits signal
          teledigits = 1;
          (ringtoneAmy == 1);
          printf("got ringtone\n"); 
          ringtoneAmy =0;
          //once she recieves a ringtone she is in call state
          stateofAmy = ringing;
